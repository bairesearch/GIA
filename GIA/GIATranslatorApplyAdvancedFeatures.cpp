	...
	while(currentRelationInList->next != NULL)
	{
		...
		{			
			...
			if(governerAndDependentBothHaveSameNERvalue)
			{
				...
				disableEntityAndInstanceBasedUponFirstSentenceToAppearInNetwork(dependentEntity);	
		...
		{			
			...
			{			
				...
				else if(currentRelationInList->relationType == RELATION_TYPE_COMPLIMENT_TO_DO)
				{
					...
					if(GIAEntityNodeArray[currentRelationInList->relationGovernorIndex]->entityName != RELATION_GOVERNOR_BE)
