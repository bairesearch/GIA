					...
					{//continue only for references, eg pronoun (not for their source, eg name)
						...
						else
						{
							...
							else
							{
								...
								GIAFeatureTempEntityNodeArray[referenceEntityIndex] = referenceSource;		//added for GIA 1n8b 04-August-2012 to correct bug as resultant of advanced referencing - fill in array
								featureArrayTemp[referenceEntityIndex] = new Feature();				//added for GIA 1n8b 04-August-2012 to correct bug as resultant of advanced referencing - fill in array
								GIAConceptNodeArray[referenceEntityIndex] = referenceSource;			//added for GIA 1n8b 04-August-2012 to correct bug as resultant of advanced referencing - fill in array
							}
							#endif
