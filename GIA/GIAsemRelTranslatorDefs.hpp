...
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_UNDEFINED (LRP_SHARED_POS_TYPE_UNDEFINED)		//added in case Stanford POS extraction does not equate exactly to PENN tree bank specification
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_CONJUNCTION (LRP_SHARED_POS_TYPE_CONJUNCTION)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_NUMBER (LRP_SHARED_POS_TYPE_NUMBER)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_DETERMINER (LRP_SHARED_POS_TYPE_DETERMINER)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_UNKNOWN (LRP_SHARED_POS_TYPE_UNKNOWN)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_PREDETERMINER (LRP_SHARED_POS_TYPE_PREDETERMINER)	//predeterminer could be merged with adjective
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_POSSESSIVEENDING (LRP_SHARED_POS_TYPE_POSSESSIVEENDING)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_MODALAUXILIARY (LRP_SHARED_POS_TYPE_MODALAUXILIARY)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_PREPOSITION (LRP_SHARED_POS_TYPE_PREPOSITION)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_ADJECTIVE (LRP_SHARED_POS_TYPE_ADJECTIVE)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_NOUN (LRP_SHARED_POS_TYPE_NOUN)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_ADVERB (LRP_SHARED_POS_TYPE_ADVERB)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_PRONOUN_PERSONAL (LRP_SHARED_POS_TYPE_PRONOUN_PERSONAL)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_PRONOUN_POSSESSIVE (LRP_SHARED_POS_TYPE_PRONOUN_POSSESSIVE)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_PARTICLE (LRP_SHARED_POS_TYPE_PARTICLE)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_INTERJECTION (LRP_SHARED_POS_TYPE_INTERJECTION)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_VERB (LRP_SHARED_POS_TYPE_VERB)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_WH (LRP_SHARED_POS_TYPE_WH)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_PUNCTUATION_DIVISION (LRP_SHARED_POS_TYPE_PUNCTUATION_DIVISION)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_PUNCTUATION_QUOTE (LRP_SHARED_POS_TYPE_PUNCTUATION_QUOTE)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_PUNCTUATION_END_OF_SENTENCE (LRP_SHARED_POS_TYPE_NAME_PUNCTUATION_END_OF_SENTENCE)
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_AUXILIARY_BEING (LRP_SHARED_POS_TYPE_AUXILIARY_BEING)		//additional case required for GIA semantics extraction
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_AUXILIARY_HAVING (LRP_SHARED_POS_TYPE_AUXILIARY_HAVING)		//additional case required for GIA semantics extraction
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_AUXILIARY_DOING (LRP_SHARED_POS_TYPE_AUXILIARY_DOING)		//additional case required for GIA semantics extraction
...
static string featurePOStagAdverbArray[FEATURE_POS_TAG_ADVERB_ARRAY_NUMBER_OF_TYPES] = {FEATURE_POS_TAG_ADVERB_RB, FEATURE_POS_TAG_ADVERB_COMPARATIVE_RBR, FEATURE_POS_TAG_ADVERB_SUPERLATIVE_RBS};
...
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_DETERMINER_LIMITED_INDEFINITE (LRP_SHARED_POS_TYPE_AUXILIARY_DOING+1)	//OLD: LRP_SHARED_POS_TYPE_AUXILIARY_DOING
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_SPECIAL_REDUCED_CONJUNCTION (LRP_SHARED_POS_TYPE_AUXILIARY_DOING+2)	//OLD: LRP_SHARED_POS_TYPE_AUXILIARY_DOING+1
#define GIA_SEM_REL_TRANSLATOR_POS_TYPE_ARRAY_NUMBER_OF_TYPES (LRP_SHARED_POS_TYPE_AUXILIARY_DOING+3)		//OLD: LRP_SHARED_POS_TYPE_AUXILIARY_DOING+2
static string GIAconnectionistNetworkPOStypeNameArray[GIA_SEM_REL_TRANSLATOR_POS_TYPE_ARRAY_NUMBER_OF_TYPES] = {LRP_SHARED_POS_TYPE_NAME_UNDEFINED, LRP_SHARED_POS_TYPE_NAME_CONJUNCTION, LRP_SHARED_POS_TYPE_NAME_NUMBER, LRP_SHARED_POS_TYPE_NAME_DETERMINER, LRP_SHARED_POS_TYPE_NAME_UNKNOWN, LRP_SHARED_POS_TYPE_NAME_PREDETERMINER, LRP_SHARED_POS_TYPE_NAME_POSSESSIVEENDING, LRP_SHARED_POS_TYPE_NAME_MODALAUXILIARY, LRP_SHARED_POS_TYPE_NAME_PREPOSITION, LRP_SHARED_POS_TYPE_NAME_ADJECTIVE, LRP_SHARED_POS_TYPE_NAME_NOUN, LRP_SHARED_POS_TYPE_NAME_ADVERB, LRP_SHARED_POS_TYPE_NAME_PRONOUN_PERSONAL, LRP_SHARED_POS_TYPE_NAME_PRONOUN_POSSESSIVE, LRP_SHARED_POS_TYPE_NAME_PARTICLE, LRP_SHARED_POS_TYPE_NAME_INTERJECTION, LRP_SHARED_POS_TYPE_NAME_VERB, LRP_SHARED_POS_TYPE_NAME_WH, LRP_SHARED_POS_TYPE_NAME_PUNCTUATION_QUOTE, LRP_SHARED_POS_TYPE_NAME_PUNCTUATION_DIVISION, LRP_SHARED_POS_TYPE_NAME_PUNCTUATION_END_OF_SENTENCE, LRP_SHARED_POS_TYPE_NAME_AUXILIARY_BEING, LRP_SHARED_POS_TYPE_NAME_AUXILIARY_HAVING, LRP_SHARED_POS_TYPE_NAME_AUXILIARY_DOING, GIA_SEM_REL_TRANSLATOR_POS_TYPE_NAME_DETERMINER_LIMITED_INDEFINITE, GIA_SEM_REL_TRANSLATOR_POS_TYPE_NAME_SPECIAL_REDUCED_CONJUNCTION};
...
//#ifndef LRP_PREPROCESSOR_WORD_MULTIWORD_REDUCTION
#define GIA_ENTITY_VECTOR_CONNECTION_TYPE_MULTIWORD_PREPOSITION (25)	//assumes that LRP_PREPROCESSOR_WORD_MULTIWORD_REDUCTION multiword preposition reduction is disabled
//#endif
