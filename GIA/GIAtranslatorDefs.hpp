...
#define GIA_SHARED_POS_TYPE_PUNCTUATION_DIVISION 18
#define GIA_SHARED_POS_TYPE_PUNCTUATION_QUOTE 19
#define GIA_SHARED_POS_TYPE_AUXILIARY_BEING 20
#define GIA_SHARED_POS_TYPE_AUXILIARY_HAVING 21
#define GIA_SHARED_POS_TYPE_AUXILIARY_DOING 22
#define GIA_SHARED_POS_TYPE_PUNCTUATION_END_OF_SENTENCE 23	
#define GIA_SHARED_POS_TYPE_PRONOUN_DEMONSTRATIVE 24
#define GIA_SHARED_POS_TYPE_PRONOUN_INDEFINITE 25
#define GIA_SHARED_POS_TYPE_PRONOUN_INTERROGATIVE 26	
#define GIA_SHARED_POS_TYPE_PRONOUN_PERSONAL_OBJECT 27
#define GIA_SHARED_POS_TYPE_PRONOUN_PERSONAL_SUBJECT 28	
#define GIA_SHARED_POS_TYPE_PRONOUN_POSSESSIVE_ADJECTIVE 29
#define GIA_SHARED_POS_TYPE_PRONOUN_POSSESSIVE_ALONE 30
#define GIA_SHARED_POS_TYPE_PRONOUN_REFLEXIVE 31	
#define GIA_SHARED_POS_TYPE_PRONOUN_RELATIVE 32
#define GIA_SHARED_POS_TYPE_CONJUNCTION_COORDINATING 33
#define GIA_SHARED_POS_TYPE_CONJUNCTION_SUBCOORDINATING 34
#define GIA_SHARED_POS_TYPE_CONJUNCTION_CORRELATIVE_FIRST 35	
#define GIA_SHARED_POS_TYPE_CONJUNCTION_CORRELATIVE_SECOND 36
#define GIA_SHARED_POS_TYPE_ARRAY_NUMBER_OF_TYPES (37)	
...
#define 
#define GIA_SEMANTIC_PARSER_POS_TYPE_NAME_DETERMINER_LIMITED_INDEFINITE "determinerLimitedIndefinite"
#define GIA_SEMANTIC_PARSER_POS_TYPE_NAME_SPECIAL_REDUCED_CONJUNCTION "specialReducedConjunction"
#define GIA_SEMANTIC_PARSER_POS_TYPE_UNDEFINED (GIA_SHARED_POS_TYPE_UNDEFINED)		//added in case Stanford POS extraction does not equate exactly to PENN tree bank specification
#define GIA_SEMANTIC_PARSER_POS_TYPE_CONJUNCTION (GIA_SHARED_POS_TYPE_CONJUNCTION)
#define GIA_SEMANTIC_PARSER_POS_TYPE_NUMBER (GIA_SHARED_POS_TYPE_NUMBER)
#define GIA_SEMANTIC_PARSER_POS_TYPE_DETERMINER (GIA_SHARED_POS_TYPE_DETERMINER)
#define GIA_SEMANTIC_PARSER_POS_TYPE_UNKNOWN (GIA_SHARED_POS_TYPE_UNKNOWN)
#define GIA_SEMANTIC_PARSER_POS_TYPE_PREDETERMINER (GIA_SHARED_POS_TYPE_PREDETERMINER)	//predeterminer could be merged with adjective
#define GIA_SEMANTIC_PARSER_POS_TYPE_POSSESSIVEENDING (GIA_SHARED_POS_TYPE_POSSESSIVEENDING)
#define GIA_SEMANTIC_PARSER_POS_TYPE_MODALAUXILIARY (GIA_SHARED_POS_TYPE_MODALAUXILIARY)
#define GIA_SEMANTIC_PARSER_POS_TYPE_PREPOSITION (GIA_SHARED_POS_TYPE_PREPOSITION)
#define GIA_SEMANTIC_PARSER_POS_TYPE_ADJECTIVE (GIA_SHARED_POS_TYPE_ADJECTIVE)
#define GIA_SEMANTIC_PARSER_POS_TYPE_NOUN (GIA_SHARED_POS_TYPE_NOUN)
#define GIA_SEMANTIC_PARSER_POS_TYPE_ADVERB (GIA_SHARED_POS_TYPE_ADVERB)
#define GIA_SEMANTIC_PARSER_POS_TYPE_PRONOUN_PERSONAL (GIA_SHARED_POS_TYPE_PRONOUN_PERSONAL)
#define GIA_SEMANTIC_PARSER_POS_TYPE_PRONOUN_POSSESSIVE (GIA_SHARED_POS_TYPE_PRONOUN_POSSESSIVE)
#define GIA_SEMANTIC_PARSER_POS_TYPE_PARTICLE (GIA_SHARED_POS_TYPE_PARTICLE)
#define GIA_SEMANTIC_PARSER_POS_TYPE_INTERJECTION (GIA_SHARED_POS_TYPE_INTERJECTION)
#define GIA_SEMANTIC_PARSER_POS_TYPE_VERB (GIA_SHARED_POS_TYPE_VERB)
#define GIA_SEMANTIC_PARSER_POS_TYPE_WH (GIA_SHARED_POS_TYPE_WH)
#define GIA_SEMANTIC_PARSER_POS_TYPE_PUNCTUATION_DIVISION (GIA_SHARED_POS_TYPE_PUNCTUATION_DIVISION)
#define GIA_SEMANTIC_PARSER_POS_TYPE_PUNCTUATION_QUOTE (GIA_SHARED_POS_TYPE_PUNCTUATION_QUOTE)
#define GIA_SEMANTIC_PARSER_POS_TYPE_AUXILIARY_BEING (GIA_SHARED_POS_TYPE_AUXILIARY_BEING)		//additional case required for GIA semantics extraction
#define GIA_SEMANTIC_PARSER_POS_TYPE_AUXILIARY_HAVING (GIA_SHARED_POS_TYPE_AUXILIARY_HAVING)		//additional case required for GIA semantics extraction
#define GIA_SEMANTIC_PARSER_POS_TYPE_AUXILIARY_DOING (GIA_SHARED_POS_TYPE_AUXILIARY_DOING)		//additional case required for GIA semantics extraction
#define GIA_SEMANTIC_PARSER_POS_TYPE_DETERMINER_LIMITED_INDEFINITE (GIA_SHARED_POS_TYPE_AUXILIARY_DOING)
#define GIA_SEMANTIC_PARSER_POS_TYPE_SPECIAL_REDUCED_CONJUNCTION (GIA_SHARED_POS_TYPE_AUXILIARY_DOING+1)
#define GIA_SEMANTIC_PARSER_POS_TYPE_ARRAY_NUMBER_OF_TYPES (GIA_SHARED_POS_TYPE_AUXILIARY_DOING+2)
static string GIAconnectionistNetworkPOStypeNameArray[GIA_SEMANTIC_PARSER_POS_TYPE_ARRAY_NUMBER_OF_TYPES] = {GIA_SHARED_POS_TYPE_NAME_UNDEFINED, GIA_SHARED_POS_TYPE_NAME_CONJUNCTION, GIA_SHARED_POS_TYPE_NAME_NUMBER, GIA_SHARED_POS_TYPE_NAME_DETERMINER, GIA_SHARED_POS_TYPE_NAME_UNKNOWN, GIA_SHARED_POS_TYPE_NAME_PREDETERMINER, GIA_SHARED_POS_TYPE_NAME_POSSESSIVEENDING, GIA_SHARED_POS_TYPE_NAME_MODALAUXILIARY, GIA_SHARED_POS_TYPE_NAME_PREPOSITION, GIA_SHARED_POS_TYPE_NAME_ADJECTIVE, GIA_SHARED_POS_TYPE_NAME_NOUN, GIA_SHARED_POS_TYPE_NAME_ADVERB, GIA_SHARED_POS_TYPE_NAME_PRONOUN_PERSONAL, GIA_SHARED_POS_TYPE_NAME_PRONOUN_POSSESSIVE, GIA_SHARED_POS_TYPE_NAME_PARTICLE, GIA_SHARED_POS_TYPE_NAME_INTERJECTION, GIA_SHARED_POS_TYPE_NAME_VERB, GIA_SHARED_POS_TYPE_NAME_WH, GIA_SHARED_POS_TYPE_NAME_PUNCTUATION_DIVISION, GIA_SHARED_POS_TYPE_NAME_PUNCTUATION_QUOTE, GIA_SHARED_POS_TYPE_NAME_AUXILIARY_BEING, GIA_SHARED_POS_TYPE_NAME_AUXILIARY_HAVING, GIA_SHARED_POS_TYPE_NAME_AUXILIARY_DOING, GIA_SEMANTIC_PARSER_POS_TYPE_NAME_DETERMINER_LIMITED_INDEFINITE, GIA_SEMANTIC_PARSER_POS_TYPE_NAME_SPECIAL_REDUCED_CONJUNCTION};
...
#define GIA_SEMANTIC_PARSER_POS_TYPE_ARRAY_NUMBER_OF_TYPES (13)
static string GIAconnectionistNetworkPOStypeNameArray[GIA_SEMANTIC_PARSER_POS_TYPE_ARRAY_NUMBER_OF_TYPES] = {"isNoun", "isVerbOrParticiple", "isAdjectiveOrAdverb", "isPreposition", "isAuxillaryBeing", "isAuxillaryHaving", "isAuxillaryDoing", "isAuxillaryModal", "isDeterminerThatWhich", "isDeterminer", "isComma", "isConjunction", "isInterjection"};
*/
