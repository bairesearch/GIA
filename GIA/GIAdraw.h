...
#else
	#define GIA_DRAW_ACTION_DEFINITION_CONNECTION_COLOUR (GIA_DRAW_CONCEPT_CONNECTION_COLOUR)
...
#else
	#define GIA_DRAW_CONDITION_DEFINITION_CONNECTION_COLOUR (GIA_DRAW_CONCEPT_NODE_COLOUR)
	#define GIA_DRAW_CONDITION_DEFINITION_NODE_COLOUR (GIA_DRAW_CONCEPT_CONNECTION_COLOUR)		//this was dark green to original GIA spec
#endif
...
#else
	#define GIA_DRAW_PROPERTY_DEFINITION_CONNECTION_COLOUR (GIA_DRAW_CONCEPT_CONNECTION_COLOUR)
