...
*/
	...
	#define GIA_DRAW_NETWORK_INDEX_NODE_COLOUR (DAT_FILE_COLOUR_WHITE)
#else
	#define GIA_DRAW_DEFINITION_CONNECTION_COLOUR (DAT_FILE_COLOUR_BLUE)			//this was black in the original spec
	#define GIA_DRAW_NETWORK_INDEX_NODE_COLOUR (DAT_FILE_COLOUR_BLUE)				//this was blue in the original spec
#endif
...
#else
	#define GIA_DRAW_CONDITION_DEFINITION_NODE_COLOUR (GIA_DRAW_NETWORK_INDEX_NODE_COLOUR)		//this was dark green to original GIA spec
#endif
#ifdef GIA_DRAW_USE_UNIQUE_COLOURS_FOR_ENTITY_DEFINITION_CONNECTIONS
...
#else
	#define GIA_DRAW_SUBSTANCE_DEFINITION_NODE_COLOUR (GIA_DRAW_NETWORK_INDEX_NODE_COLOUR)
#endif
#ifdef GIA_DRAW_USE_UNIQUE_COLOURS_FOR_ENTITY_DEFINITION_CONNECTIONS
