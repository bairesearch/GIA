...
static int entityVectorConnectionDrawPosXinitialArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {DRAW_X_SPACE_BETWEEN_ACTION_NODES, -DRAW_X_SPACE_BETWEEN_ACTION_NODES, DRAW_X_SPACE_BETWEEN_CONDITION_NODES, -DRAW_X_SPACE_BETWEEN_CONDITION_NODES, DRAW_X_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_X_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_X_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_X_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_X_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES, -DRAW_X_SPACE_BETWEEN_ACTION_NODES, DRAW_X_SPACE_BETWEEN_ACTION_NODES, -DRAW_X_SPACE_BETWEEN_CONDITION_NODES, DRAW_X_SPACE_BETWEEN_CONDITION_NODES, -DRAW_X_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES};
static int entityVectorConnectionDrawPosYspacingArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {DRAW_Y_SPACE_BETWEEN_ACTIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_ACTIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_CONDITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_CONDITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_BASICCONNECTION_OF_SAME_NODE_IRRELEVANT, DRAW_Y_SPACE_BETWEEN_BASICCONNECTION_OF_SAME_NODE_IRRELEVANT, DRAW_Y_SPACE_BETWEEN_BASICCONNECTION_OF_SAME_NODE_IRRELEVANT, DRAW_Y_SPACE_BETWEEN_BASICCONNECTION_OF_SAME_NODE_IRRELEVANT, DRAW_Y_SPACE_BETWEEN_BASICCONNECTION_OF_SAME_NODE_IRRELEVANT};
