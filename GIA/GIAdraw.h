...
static int entityVectorConnectionDrawPosYinitialArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {DRAW_Y_SPACE_BETWEEN_ACTION_NODES, -DRAW_Y_SPACE_BETWEEN_ACTION_NODES, DRAW_Y_SPACE_BETWEEN_CONDITION_NODES, -DRAW_Y_SPACE_BETWEEN_CONDITION_NODES, DRAW_Y_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_Y_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_Y_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES};
static int entityVectorConnectionDrawPosXinitialArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {DRAW_X_SPACE_BETWEEN_ACTION_NODES, -DRAW_X_SPACE_BETWEEN_ACTION_NODES, DRAW_X_SPACE_BETWEEN_CONDITION_NODES, -DRAW_X_SPACE_BETWEEN_CONDITION_NODES, DRAW_X_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_X_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_X_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_X_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_X_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES};
static int entityVectorConnectionDrawPosYspacingArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {DRAW_Y_SPACE_BETWEEN_ACTIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_ACTIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_CONDITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_CONDITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_ENTITIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE};
static string entityVectorConnectionDrawConnectionNameArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {"NA", "NA", "NA", "NA", "NA", "property", "definition", "NA", "NA"};
static int entityVectorConnectionDrawColourNameArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {GIA_DRAW_UNDEFINED_CONNECTION_COLOUR, GIA_DRAW_UNDEFINED_CONNECTION_COLOUR, GIA_DRAW_UNDEFINED_CONNECTION_COLOUR, GIA_DRAW_UNDEFINED_CONNECTION_COLOUR, GIA_DRAW_UNDEFINED_CONNECTION_COLOUR, GIA_DRAW_PROPERTY_CONNECTION_COLOUR, GIA_DRAW_CONCEPT_CONNECTION_COLOUR, GIA_DRAW_UNDEFINED_CONNECTION_COLOUR, GIA_DRAW_UNDEFINED_CONNECTION_COLOUR};
static bool entityVectorConnectionDrawConnectionArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {false, false, false, false, false, true, true, false, false};

static int entityBasicConnectionDrawPosYinitialArray[GIA_ENTITY_NUMBER_OF_BASIC_CONNECTION_TYPES] = {-DRAW_Y_SPACE_BETWEEN_ACTION_NODES, DRAW_Y_SPACE_BETWEEN_ACTION_NODES, -DRAW_Y_SPACE_BETWEEN_CONDITION_NODES, DRAW_Y_SPACE_BETWEEN_CONDITION_NODES, -DRAW_Y_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES};
static int entityBasicConnectionDrawPosXinitialArray[GIA_ENTITY_NUMBER_OF_BASIC_CONNECTION_TYPES] = {-DRAW_X_SPACE_BETWEEN_ACTION_NODES, DRAW_X_SPACE_BETWEEN_ACTION_NODES, -DRAW_X_SPACE_BETWEEN_CONDITION_NODES, DRAW_X_SPACE_BETWEEN_CONDITION_NODES, -DRAW_X_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES};
static string entityBasicConnectionDrawConnectionNameArray[GIA_ENTITY_NUMBER_OF_BASIC_CONNECTION_TYPES] = {"subject", "object", "subject", "object", "instance"};
static int entityBasicConnectionDrawColourNameArray[GIA_ENTITY_NUMBER_OF_BASIC_CONNECTION_TYPES] = {GIA_DRAW_ACTION_SUBJECT_CONNECTION_COLOUR, GIA_DRAW_ACTION_OBJECT_CONNECTION_COLOUR, GIA_DRAW_CONDITION_SUBJECT_CONNECTION_COLOUR, GIA_DRAW_CONDITION_OBJECT_CONNECTION_COLOUR, GIA_DRAW_UNDEFINED_CONNECTION_COLOUR};	//instance colour is dynamicallyDetermined
static bool entityBasicConnectionDrawConnectionArray[GIA_ENTITY_NUMBER_OF_BASIC_CONNECTION_TYPES] = {true, true, true, true, true};
