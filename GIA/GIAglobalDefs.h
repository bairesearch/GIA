...
//#define GIA_DISABLE_2m_CODE_FOR_DEBUG
	...
	#endif
	#define GIA_TRANSLATOR_INTERPRET_PRENOMINAL_MODIFIER_DEFINITIONS	//2m1c - create subclasses based on prenominal modifiers (eg toyshop:shop), or add alias (eg "the planet Earth")
	#ifdef GIA_TRANSLATOR_INTERPRET_PRENOMINAL_MODIFIER_DEFINITIONS
		#define GIA_TRANSLATOR_INTERPRET_PRENOMINAL_MODIFIER_DISABLE_PROPERTIES_OR_DEFINITIONS	//2m1a/b
		#define GIA_TRANSLATOR_INTERPRET_PRENOMINAL_MODIFIER_DEFINITIONS_ENABLE_INCONSISTENT_REFERENCING	//2m4a	//eg The fruit is an apple. The apple fruit is happy.
		#define GIA_TRANSLATOR_INTERPRET_PRENOMINAL_MODIFIER_DEFINITIONS_ARTIFICAL_ENTITY_INDEX (-1)	//2m5a
		#define GIA_TRANSLATOR_INTERPRET_PRENOMINAL_MODIFIER_DEFINITIONS_DISABLE_REFERENCING_OF_SUBCLASS_ARTIFICIAL_ENTITIES	//2m5a
		#define GIA_TRANSLATOR_INTERPRET_PRENOMINAL_MODIFIER_DEFINITIONS_DETECT_USER_DECLARED_SUBCLASS_ENTITIES	//2m6a
	#endif
