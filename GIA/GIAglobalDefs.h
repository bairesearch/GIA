...
#define GIA_SUPPORT_INCONSISTENCY_BETWEEN_STANFORD_PARSER_AND_STANFORD_CORENLP_PARSING_OF_CONSECUTIVE_FULL_STOPS
	...
	#define GIA_WITH_CE_CONVERT_PUNCTUATION_MARK_CHARACTERS_TO_FULL_STOPS
		...
		#define GIA_WITH_CE_CONVERT_PUNCTUATION_MARK_CHARACTERS_TO_FULL_STOPS_BIAS_REPLACEMENT_TOWARDS_END_OF_CLAIM_BASED_ON_EXPECTED_GREATED_DISTANCE_BETWEEN_PUNCTUATION_MARKS
	#endif
...
#define USE_WORDNET	(takes into account synonymns)
	...
	#define WORDNET_CAPI_MEMORY_LEAK	//added 22 Sept 2012
	#ifdef WORDNET_CAPI_MEMORY_LEAK
		#define GIA_USE_SYNONYMN_DETECTION_ONLY_DURING_QUERIES	//added 22 Sept 2012
	#endif
#endif
