...
#define GIA_REDISTRIBUTE_RELATIONS_SUPPORT_NAME_OF
	...
	#define GIA_REDISTRIBUTE_RELATIONS_INTERPRET_OF_AS_POSSESSIVE_OF "of"
	#define GIA_REDISTRIBUTE_RELATIONS_SUPPORT_NAME_OF_SUBJECT_DEPENDENT_NAME "name"
	#define GIA_REDISTRIBUTE_RELATIONS_SUPPORT_NAME_OF_SUBJECT_DEPENDENT_NUMBER "number"
#endif
