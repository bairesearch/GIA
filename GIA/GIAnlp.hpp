...
class GIAnlpClass
{
	...
	#endif
	public: void executeNLPparser(string inputTextPlainTXTfileName, string inputTextNLPXMLfileName, GIAtranslatorVariablesClass* translatorVariables, bool parseRelationsOrFeatures);

	public: bool parseNLPparserFile(string inputTextNLPrelationXMLfileName, string inputTextNLPfeatureXMLfileName, bool isQuery, GIAsentence* firstSentenceInList, int NLPfeatureParser, int NLPdependencyRelationsParser, bool NLPrelexCompatibilityMode);
		public: bool parseNLPparserFeaturesFile(string inputTextNLPfeatureXMLfileName, bool isQuery, GIAsentence* firstSentenceInList, int NLPfeatureParser, bool* createNewSentences);
		public: bool parseNLPparserRelationsFile(string inputTextNLPrelationXMLfileName, bool isQuery, GIAsentence* firstSentenceInList, int NLPdependencyRelationsParser, bool NLPrelexCompatibilityMode, bool createNewSentences, bool onlyParseIfCorpusLookupFailed);
			#ifdef GIA_RELEX
			private: bool parseRelexFile(string inputTextNLPrelationXMLfileName, bool isQuery, GIAsentence* firstSentenceInList, bool parseRelations, bool parseFeatures, bool NLPrelexCompatibilityMode, bool createNewSentences, bool onlyParseIfCorpusLookupFailed);
			#endif
			#ifdef GIA_STANFORD_CORENLP
			private: bool parseStanfordCoreNLPfile(string inputTextNLPrelationXMLfileName, bool isQuery, GIAsentence* firstSentenceInList, bool parseRelations, bool parseFeatures, bool createNewSentences, bool onlyParseIfCorpusLookupFailed);
			#endif
			#ifdef GIA_STANFORD_PARSER
			public: bool parseStanfordParserFile(string inputTextNLPrelationXMLfileName, bool isQuery, GIAsentence* firstSentenceInList, bool createNewSentences, bool onlyParseIfCorpusLookupFailed);
				public: bool parseStanfordParserFile(string inputTextNLPrelationXMLfileName, bool isQuery, GIAsentence* firstSentenceInList, bool createNewSentences, bool parseGIA2file, bool onlyParseIfCorpusLookupFailed);
			#endif
				private: int countSubstring(std::string& str, std::string& sub);

	#ifdef GIA_OUTPUT_INTERNAL_RELATIONS_IN_RELEX_FORMAT
	public: void outputInternalRelationsInRelexFormat(string* nameOfRelexCompactFormatCFFfile, string* originalInputFileName, GIAsentence* firstSentenceInList, int NLPdependencyRelationsParser, int NLPfeatureParser, string NLPexeFolderArray[]);
	#endif
};
