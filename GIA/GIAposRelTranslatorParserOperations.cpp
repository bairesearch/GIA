...
bool GIAposRelTranslatorParserOperationsClass::generateSemanticRelationsFromTxtRelationsWrapper(GIAtranslatorVariablesClass* translatorVariables, SANIGroupParseTree* firstParseTreeGroup, int layer)
{
	bool result = true;
...
bool GIAposRelTranslatorParserOperationsClass::generateSemanticRelationsFromTxtRelations(GIAtranslatorVariablesClass* translatorVariables, SANIGroupParseTree* currentParseTreeGroup, GIAposRelTranslatorParserForwardPropogationSignalData* parserForwardPropogationSignalData, int layer)
{
	bool result = true;
	...
	{		
		SANIComponentParseTree* componentOwner = (currentParseTreeGroup->components).at(i);
		SANIComponentParseTree* parseTreeComponent = componentOwner;
...
bool GIAposRelTranslatorParserOperationsClass::generateSemanticRelationsFromTxtRelationsPart2(GIAtranslatorVariablesClass* translatorVariables, SANIGroupParseTree* currentParseTreeGroup, vector<GIAposRelTranslatorParserForwardPropogationSignalData>* parseTreeComponentSignalDataArray, GIAposRelTranslatorParserForwardPropogationSignalData* parserForwardPropogationSignalData, int layer)
{	
	bool result = true;
	...
	//required;
	vector<SANIComponentParseTree*> parseTreeComponentSemanticRelationFunctionListArray;
	vector<SANIComponentParseTree*> parseTreeComponentSemanticRelationFunctionSubject(GIA_POS_REL_TRANSLATOR_MAX_NUMBER_OF_SEMANTIC_FUNCTIONS_EXECUTED_PER_GROUP); //= NULL;
	vector<SANIComponentParseTree*> parseTreeComponentSemanticRelationFunctionObject(GIA_POS_REL_TRANSLATOR_MAX_NUMBER_OF_SEMANTIC_FUNCTIONS_EXECUTED_PER_GROUP); //= NULL;
	vector<SANIComponentParseTree*> parseTreeComponentSemanticRelationFunctionDelimiter(GIA_POS_REL_TRANSLATOR_MAX_NUMBER_OF_SEMANTIC_FUNCTIONS_EXECUTED_PER_GROUP); //= NULL;
	...
	{	
		...
		if(specialFunctionTests)
		{
			...
			for(vector<GIAentityNode*>::iterator iter1 = (parserForwardPropogationSignalData->semanticRelationReturnFunctionEntityArray).begin(); iter1 != (parserForwardPropogationSignalData->semanticRelationReturnFunctionEntityArray).end(); )
			{
				...
				/*
				if(currentParseTreeGroup->groupTypeName == SANIGroupsTypes[GIA_POS_REL_TRANSLATOR_RULES_GROUPS_TYPE_SUBREFERENCESETAPPENDS])
				{
				...
				*/
				...
				bool sameReferenceSet = false;
				if((currentParseTreeGroup->groupTypeName == SANIGroupsTypes[GIA_POS_REL_TRANSLATOR_RULES_GROUPS_TYPE_LOGICREFERENCESETS]) ||
				(currentParseTreeGroup->groupTypeName == SANIGroupsTypes[GIA_POS_REL_TRANSLATOR_RULES_GROUPS_TYPE_REFERENCESETS]))
				{
...
#ifdef GIA_POS_REL_TRANSLATOR_RULES_GIA3_USE_SEM_REL_TRANSLATOR_PARSER
bool GIAposRelTranslatorParserOperationsClass::createSemanticRelationInMemory(GIAtranslatorVariablesClass* translatorVariables, const string semanticRelationFunctionName, const string semanticRelationFunctionConditionNewName, vector<GIAentityNode*>* entitySemanticRelationFunctionListArray, const GIAentityNode* entitySemanticRelationFunction1, const GIAentityNode* entitySemanticRelationFunction2, const GIAentityNode* entitySemanticRelationFunction3, bool sameReferenceSet, const bool semanticRelationReturnConnectionDynamic)
{
	bool result = true;
...
#else
bool GIAposRelTranslatorParserOperationsClass::createSemanticRelationInNetwork(GIAtranslatorVariablesClass* translatorVariables, const string semanticRelationFunctionName, string semanticRelationFunctionConditionNewName, vector<GIAentityNode*>* entitySemanticRelationFunctionListArray, GIAentityNode* entitySemanticRelationFunction1, GIAentityNode* entitySemanticRelationFunction2, GIAentityNode* entitySemanticRelationFunction3, bool sameReferenceSet, const bool semanticRelationReturnConnectionDynamic)
{
	bool result = true;
