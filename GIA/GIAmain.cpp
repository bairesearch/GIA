...
"\n\n\tThis program performs SANI (Sequentially Activated Neuronal Input neural network) operations - creates sequentially activated neural network based upon text file; outputs neural network to ANN neural network file (.xml); prints neural network to raster image (.ppm), 3D vector graphics (.ldr), or 2D vector graphics (.svg).\n\n";
...
int main(const int argc, const char** argv)
{
	...
	*/
	...
	{
		cout << "SANI.exe - Project Version: 3m6a 09-September-2020" << endl;
		exit(EXIT_OK);
	}
...
int main(const int argc, const char** argv)
{
	...
	if(SHAREDvarsClass().argumentExists(argc, argv, "-version"))
	{
		cout << "GIA.exe - Project Version: 3m6a 09-September-2020" << endl;
		exit(EXIT_OK);
	}
