...
//#define GIA_DEBUG_DISABLE_3f_CODE
	...
	#define GIA_PREPROCESSOR_WORD_VERB_VARIANTS_PRORITISE_IRREGULAR_VERB_INFO	//GIA3f2i
	#define GIA_PREPROCESSOR_WORD_NOUN_VARIANTS_PRIORITISE_IRREGULAR_PLURAL_FORM	//GIA3f5a 
		...
		#define GIA_POS_REL_TRANSLATOR_RULES
				...
				#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES    
			#endif
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS3
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS2
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_PRINT_PARSE_PROCESS
			...
			//#define GIA_DEBUG_POS_REL_TRANSLATOR_RULES_SYN_REL_TRANSLATOR_OUTPUT_BACKWARDS_COMPATIBILITY  //not supported (due to propernouns being replicated in wordlistNouns.txt)
			...
			#define GIA_POS_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES	//precondition: all optional strings must have a known pos type to be processed (unknown not supported)
				...
				#endif
				#define GIA_POS_REL_TRANSLATOR_RULES_TREAT_UNKNOWN_POSTYPES_MID_SENTENCE_CAPITALISED_WORDS_AS_PROPERNOUNS	//GIA3f10i
			...
			#define GIA_POS_REL_TRANSLATOR_RULES_LAYER_START (1)
			...
			#define GIA_PREPROCESSOR_INITIALISE_WORD_INDEX_LIST_FROM_LRP_FILES	//this is required to detect all possible pos types for wordList words
				...
				#ifndef GIA_DEBUG_POS_REL_TRANSLATOR_RULES_SYN_REL_TRANSLATOR_OUTPUT_BACKWARDS_COMPATIBILITY
					#define GIA_PREPROCESSOR_INITIALISE_WORD_INDEX_LIST_FROM_LRP_FILES_SUPPORT_UPPERCASE_PROPERNOUN_WORD_LISTS	//NB this is not backwards compatible with GIAsynRelTranslator
						...
						//#define GIA_PREPROCESSOR_INITIALISE_WORD_INDEX_LIST_FROM_LRP_FILES_SUPPORT_UPPERCASE_PROPERNOUN_WORD_LISTS_IF_FIRST_WORD_OF_SENTENCE_IS_IN_PROPERNOUN_LIST_THEN_CHECK_OTHER_LISTS_ALSO	//alternate implementation (not robust either)
					#endif
				#endif
			#endif
			...
			#define GIA_POS_REL_TRANSLATOR_RULES_GIA3	//GIA3
				...
				#define GIA_PREPROCESSOR_WORD_STORE_REDUNDANT_SUPERSET_WORD_LISTS	//e.g. record pronoun list, not just specific pronoun lists (not supported by GIA pos tagger; only supported by GIA_POS_REL_TRANSLATOR_RULES)
...
//#define GIA_DEBUG_DISABLE_3e_CODE
	...
	#define GIA_POS_REL_TRANSLATOR_HYBRID_DETERMINE_AMBIGUOUS_PREPOSITION_POS_TYPES_BASED_ON_CONTEXT	//GIA3e12a	//uses heuristics to verify preposition pos type - designed to replace the need for a more accurate pos tagger; GIA_POS_REL_TRANSLATOR_HYBRID_EXECUTE_PRELIM_POS_TAGGER/GIA_PREPROCESSOR_POS_TAGGER
	...
	//#define GIA_PREPROCESSOR_WORD_DYNAMIC //GIA3e11a	//collapses any two consective words found in same wordlist (ie predicted to be of same pos type); even if this is not 100% accuracy (due to ambiguous POS types) it should be sufficient for GIA pos tagger database training
	...
	#define GIA_POS_REL_TRANSLATOR_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY_VALUE_IRRELEVANT (false)
	//#define GIA_PREPROCESSOR_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY	//disabled as higher level semantic processing of actions interprets all verb variants (regardless of whether they are grammatically strict verbs) as verbs
		...
		#define GIA_POS_REL_TRANSLATOR_STORE_REFERENCE_SETS	//mandatory with GIA_POS_REL_TRANSLATOR_HYBRID as hybrid uses reference sets
			...
			//#ifndef GIA_POS_REL_TRANSLATOR_HYBRID_DETERMINE_AMBIGUOUS_PREPOSITION_POS_TYPES_BASED_ON_CONTEXT
				#define GIA_POS_REL_TRANSLATOR_HYBRID_EXECUTE_PRELIM_POS_TAGGER	//GIA3e1a	//either uses third party NLP POS tagger or GIA pos tagger (GIA_PREPROCESSOR_POS_TAGGER)
				#ifdef GIA_POS_REL_TRANSLATOR_HYBRID_EXECUTE_PRELIM_POS_TAGGER
					#define GIA_PREPROCESSOR_POS_TAGGER	//GIA3e2a	//GIA pos tagger (optional); else use third party NLP pos tagger
				#endif
			//#endif
		#endif
		#ifdef GIA_POS_REL_TRANSLATOR_HYBRID_EXECUTE_PRELIM_POS_TAGGER
			...
			#define GIA_POS_REL_TRANSLATOR_HYBRID_REFERENCE_SET_PREFERENCE_VERB_OR_NOUN_OVER_ADJECTIVE_POS_AMBIGUITY	//doesnt work as it is unsure whether to select adjective over verb/noun or verb/noun over adjective. Therefore GIA_POS_REL_TRANSLATOR_HYBRID must rely on a functioning GIA_PREPROCESSOR_POS_TAGGER
		#endif
	#endif
		...
		#define GIA_PREPROCESSOR_POS_TAGGER
			...
			#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE_WITHOUT_TARGET_CLASSES
			#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE_EXCLUDE_POS_INDEX_OUT_OF_SENTENCE_BOUNDS
		#endif
		
			
		
		#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_PREDICTION_VERIFICATION	//GIA3e9b
		...
		#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_MEMORY_FREE_DELETE_PREPROCESSOR_SENTENCES_ONCE_PROCESSED
		#ifdef USE_ANN
			#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK	//GIA3e4a
		#endif
				...
				#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_FILESYSTEM	//GIA3e3a
				#ifndef GIA_PREPROCESSOR_POS_TAGGER_DATABASE_FILESYSTEM
						#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_MAP	//GIA3e2a
				#endif
			#else
			...
			#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_PERSISTENT
				...
				//#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_INTERNAL_CLASSIFICATION_NET	//GIA3e9b
		...
		#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_POS_MAX_BITS_INTERMEDIATE (64)	//size(uint64_t), i.e. 64 == GIA_PREPROCESSOR_POS_TAGGER_DATABASE_POS_MAX_NUMBER_OF_TYPES_THEORETICAL
		#ifndef GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK
			#ifdef GIA_PREPROCESSOR_POS_TAGGER_DATABASE_FEED_ALL_PERMUTATIONS_INDIVIDUALLY_ONLY_TRAIN_UNAMBIGUOUS_PERMUTATIONS
				#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_FILESYSTEM_AND_MAP_USE_6BIT_INDICES	//GIA3e9d
			...
			#define GIA_PREPROCESSOR_POS_TAGGER_GENERATE_DATABASE_DOC_XML_OUTPUT_NUMBER_OF_FILES (12)	//1203	//wiki dump files are generated with WikiExtractor (https://github.com/attardi/wikiextractor)	//121	
...
//#define GIA_DEBUG_DISABLE_3d_CODE
	...
	//#define GIA_DEBUG_PREPROCESSOR_SENTENCE_RECONCILE_REFERENCES_DISABLE	//temp debug
		...
		#endif
	#endif
	#define GIA_PREPROCESSOR_DETERMINE_VERB_CASE_ADDITIONAL_EXTENDED	//activated GIA3d5f
#endif
...
//#define GIA_DEBUG_DISABLE_3b_CODE
	...
	//#ifdef GIA_PREPROCESSOR	//has not yet been defined
		#define GIA_PREPROCESSOR_RECORD_REFERENCES	//GIA3b2a	//required by GIAI
		//#ifdef GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_INTRAWORD_PUNCTUATION_MARK	//has not yet been defined
			#define GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_ABBREVIATIONS	//GIA3b2e
			...
			#endif
		//#endif
		#define GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_APOSTROPHES_POSSESSION_AND_OMISSION	//GIA3b2e
		#define GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_DOLLARS //GIA3b2e
		#ifdef USE_NLC
			#define GIA_PREPROCESSOR_WORD_EXTRACT_INDENTATION	//GIA3b3a upgraded for NLC
			#ifdef GIA_PREPROCESSOR_WORD_EXTRACT_INDENTATION
				#define GIA_PREPROCESSOR_INDENTATION_CHAR CHAR_TAB
			#endif
			#define GIA_PREPROCESSOR_WORD_REDUCE_QUOTES_TO_SINGLE_WORDS	//GIA2b4a	//disabled GIA2i36a	//GIA3b3a restored and upgraded for NLC
		#endif	
		#define GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_MATH	//GIA3b3a	//required for NLC
		#ifdef GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_MATH
			#define GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_MATH_GROUPING	//GIA3b3a - required for current NLC implementation; e.g. see how preprocessorMathOperatorsEquivalentConjunctions are defined [need to detect individual opening/closing brackets]
		#endif
...
//#define GIA_DEBUG_DISABLE_3a_CODE
	...
	#define GIA_PREPROCESSOR_FIND_EXISTING_RELATIONSHIP_IN_SENTENCE_ENFORCE_SAME_SENTENCE_CHECKS	//GIA3a6d
	...
	#define GIA_PREPROCESSOR_WORD_REINSERT_NEWLINE_CHARACTERS_AFTER_EVERY_SENTENCE	//added GIA3a1a
	...
	#define GIA_PREPROCESSOR
		...
		#define GIA_PREPROCESSOR_WORD_LOAD_WORD_LISTS
			...
			#endif
			//#define GIA_POS_REL_TRANSLATOR_HYBRID_RECONCILE_REFERENCES_AFTER_SEMANTIC_PARSING_EVERY_SENTENCE	//this is unsupported as each GIApreprocessorSentence will contain multiple GIAsentences
...
#define GIA_CREATE_NON_SPECIFIC_CONCEPTS_FOR_ALL_NETWORK_INDEXES		//mandatory as of GIA3a1a	//2a7a
	...
	#define GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_INTRAWORD_PUNCTUATION_MARK
		...
		#define GIA_PREPROCESSOR_WORD_NLP_PARSABLE_PHRASE_SUPPORT_FILENAMES_WITH_FULLSTOPS_AND_FLOATS_AND_TIMES	//GIA2i18a
	#endif
	...
	#define GIA_SPATIOTEMPORAL_NETWORK		//yet to implement ~GIA2h2a/17-November-2014+
		...
		//#ifdef GIA_PREPROCESSOR_WORD	//not yet defined
			#define GIA_PREPROCESSOR_WORD_NORMALISE_PREPOSITIONS	//added GIA2h1a/14-November-2014 - required for NLC1m1a+
				...
				#define GIA_PREPROCESSOR_WORD_NORMALISE_TWOWAY_PREPOSITIONS
					...
					#endif
				#endif
				#define GIA_PREPROCESSOR_WORD_DETECT_PREPOSITION_TYPE		//added GIA2h1a/14-November-2014 - required for NLC1m1a+
			#endif
		//#endif
