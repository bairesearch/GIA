...
//#define GIA_DEBUG_DISABLE_3e_CODE
	...
	#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE	//3e3a
	#ifdef GIA_PREPROCESSOR_POS_TAGGER_DATABASE
		//#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_EFFICIENT_OVERWRITE_EXISTENT_REFERENCES_WITH_NEW_NUMBER_OF_INSTANCES
		//#define GIA_PREPROCESSOR_POS_TAGGER_TEST_MODE_LOAD_ALL_ENTRIES_UPON_READ
	#endif
	...
	//#ifdef GIA_PREPROCESSOR_SENTENCE	//has not yet been defined
		#define GIA_PREPROCESSOR_SENTENCE_EXECUTE_PRELIM_POS_TAGGER	//3e1a
