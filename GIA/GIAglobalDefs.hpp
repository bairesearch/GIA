...
//#define GIA_DEBUG_DISABLE_3e_CODE
	...
	#define GIA_DEBUG_PREPROCESSOR_SENTENCE_PREMATURE_QUIT	//temp - used @3e8a in debug of changes @3d5x
	...
	//#ifdef GIA_PREPROCESSOR_SENTENCE	//has not yet been defined
		#ifndef GIA_DEBUG_PREPROCESSOR_SENTENCE_PREMATURE_QUIT
	...
	//#endif
		...
		#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_MEMORY_FREE_DELETE_PREPROCESSOR_SENTENCES_ONCE_PROCESSED
			...
			#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL	//3e6a	//use keras (execute external python scripts)
				...
				#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_Y_HOT_ENCODED	//keras y_train/test array is not hot encoded
			#endif
...
//#define GIA_DEBUG_DISABLE_3d_CODE
	...
	//#define GIA_PREPROCESSOR_SENTENCE_REFERENCE_SET_DELIMITER_SPECIAL_CASE_DELIMITER_VERB_NOT_PRECEEDED_BY_THAT_WHICH_AND_NOT_PRECEEDED_BY_AUXILIARY_DETECT	//3d5d	//disabled 3e8a (not required because verb case states e.g. "the moved bike..." will be detected based on preceeding determiners, and subsequently ignored as reference set delimiters )
