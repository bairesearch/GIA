...
//#define GIA_DEBUG_DISABLE_3e_CODE
	...
	#define GIA_GRAMMATICAL_WORD_TYPES_EXTENDED	//3e5a	//required by GIA pos tagger	//determiner and conjunctions added 	//GIA only; not in wordnet
	
	//#define GIA_PREPROCESSOR_USE_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY	//disabled as higher level semantic processing of actions interprets all verb variants (regardless of whether they are grammatically strict verbs) as verbs
	#ifdef GIA_PREPROCESSOR_USE_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY
		#define GIA_PREPROCESSOR_USE_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY_VALUE (true)
	#else
		#define GIA_PREPROCESSOR_USE_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY_VALUE (false)
	#endif
	...
	#define GIA_PREPROCESSOR_POS_TAGGER	//3e2a
		...
		#ifdef GIA_PREPROCESSOR_WORD_LIST_USE_INTERJECTIONS
			//no space in array for independent pronoun list...
			#define GIA_PREPROCESSOR_WORD_LIST_INTERPRET_PRONOUN_POS_AS_NOUN_POS //required because only 8 bits allowed, so interpret POS pronouns as POS nouns for now
		#endif
		#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_SIZE (8)	//8 bit integer
		#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_VERB (0)
		#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_PREPOSITION (1)
		#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_ADVERB (2)
		#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_ADJECTIVE (3)
		#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_NOUN (4)		//GIA_PREPROCESSOR_WORD_LIST_INTERPRET_PRONOUN_POS_AS_NOUN_POS: currently includes pronouns also
		#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_CONJUNCTION (5)
		#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_DETERMINER (6)
		#ifdef GIA_PREPROCESSOR_WORD_LIST_INTERPRET_PRONOUN_POS_AS_NOUN_POS
			#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_INTERJECTION (7)
		#else
			#define GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_PRONOUN (7)
		#endif
		...
		#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE
			...
			//#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_FILESYSTEM	//3e3a
				...
				#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL	//3e6a	//use keras (execute external python scripts)
					...
					//#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_DEBUG_TRAIN_SINGLE_BATCH_ONLY	//debug
					//#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_DEBUG_TRAIN_SINGLE_EPOCH_ONLY	//debug
					...
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_Y_TRAIN_BATCH_FILE_NAME_PARTA "XtrainBatch"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_X_PREDICT_BATCH_FILE_NAME_PREPEND "XpredictBatch"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_Y_PREDICT_BATCH_FILE_NAME_PREPEND "XpredictBatch"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_BATCH_FILE_EXTENSION ".dat"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_SCRIPT_NAME_FORM "GIAPOStaggerNeuralNetworkForm.py"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_SCRIPT_NAME_TRAIN "GIAPOStaggerNeuralNetworkTrain.py"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_SCRIPT_NAME_TRAIN_EPOCH "GIAPOStaggerNeuralNetworkTrainEpoch.py"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_SCRIPT_NAME_TRAIN_EPOCH_BATCH "GIAPOStaggerNeuralNetworkTrainEpochBatch.py"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_SCRIPT_NAME_TEST "GIAPOStaggerNeuralNetworkTest.py"
					#define GIA_PREPROCESSOR_POS_TAGGER_DATABASE_NEURAL_NETWORK_EXTERNAL_SCRIPT_NAME_PREDICT "GIAPOStaggerNeuralNetworkPredict.py"
				#endif
			...
			#endif
		#else
			#define GIA_PREPROCESSOR_POS_TAGGER_MAP	//3e2a
		#endif
		...
		#define GIA_PREPROCESSOR_POS_TAGGER_POS_AMBIGUITY_INFO_PUNCTUATION_MARK_CHARACTER_END_OF_SENTENCE (127)	//ie dummy value: GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_VERB & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_PREPOSITION & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_ADVERB & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_NOUN & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_CONJUNCTION & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_INTERJECTION or equivalent
		#define GIA_PREPROCESSOR_POS_TAGGER_POS_AMBIGUITY_INFO_PUNCTUATION_MARK_CHARACTER_OTHER (63)	//ie dummy value: GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_VERB & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_PREPOSITION & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_ADVERB & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_NOUN & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_CONJUNCTION or equivalent
		#define GIA_PREPROCESSOR_POS_TAGGER_POS_AMBIGUITY_INFO_QUOTATION_CHARACTER (31)	//ie dummy value: GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_VERB & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_PREPOSITION & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_ADVERB & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_NOUN or equivalent
			...
			#define GIA_PREPROCESSOR_POS_TAGGER_POS_AMBIGUITY_INFO_CENTRE_WORD (255)	//ie dummy value: GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_VERB & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_PREPOSITION & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_ADVERB & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_NOUN & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_CONJUNCTION & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_INTERJECTION & GIA_PREPROCESSOR_WORD_LIST_ARRAY_INDEX_PRONOUN
		...
		#else
			#define GIA_PREPROCESSOR_POS_TAGGER_POS_AMBIGUITY_INFO_OUT_OF_SENTENCE_BOUNDS (255)
		...
		#endif
		#define GIA_PREPROCESSOR_POS_TAGGER_DOC_XML_OUTPUT_NUMBER_OF_FILES (1203)	//wiki dump files are generated with WikiExtractor (https://github.com/attardi/wikiextractor)	//121	
		...
		#define GIA_PREPROCESSOR_POS_TAGGER_DOC_XML_OUTPUT_FOLDER "/home/systemusername/soft/wiki/output"	//"/home/systemusername/soft/wiki/output"
		#define GIA_PREPROCESSOR_POS_TAGGER_INITIALISE_WORD_INDEX_LIST_FROM_LRP_FILES
		//#define GIA_PREPROCESSOR_POS_TAGGER_INITIALISE_WORD_INDEX_LIST_FROM_WIKI_DUMP_TEXT	//NOT USED
			...
			#define GIA_PREPROCESSOR_MULTIWORD_REDUCTION_LOAD_WORD_LISTS_ADDITIONAL
			#define GIA_PREPROCESSOR_MULTIWORD_REDUCTION_REDUCE_ALL_WORD_TYPES_ADDITIONAL
		#endif
		#define GIA_PREPROCESSOR_WIKIDUMP_MULTIWORD_FILE_EXTENSION ".basic.multiword"
		#define GIA_PREPROCESSOR_WIKIDUMP_MULTIWORD_FILE_NAME "wikidumpOutput.txt"
...
//#define GIA_DEBUG_DISABLE_3d_CODE
	...
	#define GIA_PREPROCESSOR_SENTENCE_REFERENCE_SET_DELIMITER_SPECIAL_CASE_DELIMITER_VERB_NOT_PRECEEDED_BY_THAT_WHICH_AND_NOT_PRECEEDED_BY_AUXILIARY_DETECT	//3d5d
	#define GIA_PREPROCESSOR_SENTENCE_REFERENCE_SET_DELIMITER_SPECIAL_CASE_DELIMITER_VERB_NOT_PRECEEDED_BY_THAT_WHICH_AND_NOT_PRECEEDED_BY_AUXILIARY_IGNORE	//3d5f
...
#define GIA_CREATE_NON_SPECIFIC_CONCEPTS_FOR_ALL_NETWORK_INDEXES		//mandatory as of 3a1a	//2a7a
	...
	#define GIA_SPATIOTEMPORAL_NETWORK		//yet to implement ~2h2a/17-November-2014+
		...
		#define GIA_ACTIONS_OF_ACTIONS
			...
			#ifndef GIA_PREPROCESSOR_USE_GRAMMATICALLY_STRICT_VERB_VARIANTS_ONLY
...
#define GIA_TRANSLATOR_ONLY_MERGE_ENTITY_NODES_WHEN_LINK_PREESTABLISHED_REFERENCES_GIA	//disabled GIA 2c3c [for GIA_SEMANTIC_PARSER_GENERATE_EXPERIENCES_FOR_CONNECTIONIST_NETWORK_TRAIN], upgraded and reenabled 3c4b
