...
bool GIAxmlConversionClass::readSemanticNetXMLfileOptimised(const string xmlFileName, vector<GIAentityNode*>* entityNodesActiveListComplete, unordered_map<string,GIAentityNode*>* networkIndexEntityNodesListMap, map<int, vector<GIAentityNode*>*>* entityNodesActiveListSentences)
{
	...
	for(int sentenceIndex=LRP_NLP_START_SENTENCE_INDEX; sentenceIndex<maxSentenceIndex; sentenceIndex++)
	{
...
bool GIAxmlConversionClass::readSemanticNetXMLfile(const string xmlFileName, vector<GIAentityNode*>* entityNodesActiveListComplete, constEffective vector<GIAentityNode*>* entityNodesActiveListNetworkIndexes)
{
	bool result = true;
...
bool GIAxmlConversionClass::parseSemanticNetTag(XMLparserTag* firstTagInNetwork, vector<GIAentityNode*>* entityNodesActiveListComplete, constEffective vector<GIAentityNode*>* entityNodesActiveListNetworkIndexes, const bool linkConnections)
{
	bool result = true;
...
bool GIAxmlConversionClass::writeSemanticNetXMLFile(string xmlFileName, vector<GIAentityNode*>* entityNodesActiveListComplete, const vector<GIAentityNode*>* entityNodesActiveListNetworkIndexes)
{
	bool result = true;
