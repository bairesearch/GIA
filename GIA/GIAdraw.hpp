...
//these are not used (they are dynamically replaced with the opposite of their relationship connection values eg -DRAW_Y_SPACE_BETWEEN_ACTION_NODES / -DRAW_X_SPACE_BETWEEN_DEFINITION_NODES):
#define DRAW_Y_SPACE_BETWEEN_SUBJECT_OBJECT_NODES_IRRELEVANT (0)
#define DRAW_X_SPACE_BETWEEN_SUBJECT_OBJECT_NODES_IRRELEVANT (0)
...
#define DRAW_Y_SPACE_BETWEEN_DEFINITION_NODES (50)			//OLD: should really be 1 for initialiseForPrint
#define DRAW_X_SPACE_BETWEEN_DEFINITION_NODES (0)
#define DRAW_Y_SPACE_BETWEEN_DEFINITIONS_OF_SAME_NODE (100)	
...
static int entityVectorConnectionDrawPosYinitialArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {DRAW_Y_SPACE_BETWEEN_ACTION_NODES, -DRAW_Y_SPACE_BETWEEN_ACTION_NODES, DRAW_Y_SPACE_BETWEEN_CONDITION_NODES, -DRAW_Y_SPACE_BETWEEN_CONDITION_NODES, DRAW_Y_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_Y_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_Y_SPACE_BETWEEN_DEFINITION_NODES, DRAW_Y_SPACE_BETWEEN_DEFINITION_NODES, DRAW_Y_SPACE_BETWEEN_SUBJECT_OBJECT_NODES_IRRELEVANT, -DRAW_Y_SPACE_BETWEEN_SUBJECT_OBJECT_NODES_IRRELEVANT, DRAW_Y_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES, -DRAW_Y_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES};
static int entityVectorConnectionDrawPosXinitialArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {DRAW_X_SPACE_BETWEEN_ACTION_NODES, -DRAW_X_SPACE_BETWEEN_ACTION_NODES, DRAW_X_SPACE_BETWEEN_CONDITION_NODES, -DRAW_X_SPACE_BETWEEN_CONDITION_NODES, DRAW_X_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_X_SPACE_BETWEEN_PROPERTY_NODES, -DRAW_X_SPACE_BETWEEN_DEFINITION_NODES, DRAW_X_SPACE_BETWEEN_DEFINITION_NODES, DRAW_X_SPACE_BETWEEN_SUBJECT_OBJECT_NODES_IRRELEVANT, -DRAW_X_SPACE_BETWEEN_SUBJECT_OBJECT_NODES_IRRELEVANT, DRAW_X_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES, -DRAW_X_SPACE_BETWEEN_INSTANCE_DEFINITION_NODES};
static int entityVectorConnectionDrawPosYspacingArray[GIA_ENTITY_NUMBER_OF_VECTOR_CONNECTION_TYPES] = {DRAW_Y_SPACE_BETWEEN_ACTIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_ACTIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_CONDITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_CONDITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_DEFINITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_DEFINITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_BASICCONNECTION_OF_SAME_NODE_IRRELEVANT, DRAW_Y_SPACE_BETWEEN_BASICCONNECTION_OF_SAME_NODE_IRRELEVANT, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_BASICCONNECTION_OF_SAME_NODE_IRRELEVANT};
...
static int relationshipEntityVectorConnectionDrawPosYinitialArray[GIA_RELATIONSHIP_ENTITY_NUMBER_OF_TYPES] = {DRAW_Y_SPACE_BETWEEN_ACTION_NODES, DRAW_Y_SPACE_BETWEEN_CONDITION_NODES, DRAW_Y_SPACE_BETWEEN_PROPERTY_NODES, DRAW_Y_SPACE_BETWEEN_DEFINITION_NODES};
static int relationshipEntityVectorConnectionDrawPosXinitialArray[GIA_RELATIONSHIP_ENTITY_NUMBER_OF_TYPES] = {DRAW_X_SPACE_BETWEEN_ACTION_NODES, DRAW_X_SPACE_BETWEEN_CONDITION_NODES, DRAW_X_SPACE_BETWEEN_PROPERTY_NODES, DRAW_X_SPACE_BETWEEN_DEFINITION_NODES};
static int relationshipEntityVectorConnectionDrawPosYspacingArray[GIA_RELATIONSHIP_ENTITY_NUMBER_OF_TYPES] = {DRAW_Y_SPACE_BETWEEN_ACTIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_CONDITIONS_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_PROPERTIES_OF_SAME_NODE, DRAW_Y_SPACE_BETWEEN_DEFINITIONS_OF_SAME_NODE};
